...
if [ ! -f "$MU_DIR/auditra-mu-fixture.php" ]; then
  cat > "$MU_DIR/auditra-mu-fixture.php" <<'PHP'
<?php
/**
 * Plugin Name: Auditra MU Fixture
 * Description: Test fixture: a must-use plugin, to verify mu-plugin inventory. Does nothing.
 * Version: 1.0
 */
PHP
  echo "mu_plugin=auditra-mu-fixture.php" >> "$STATE_FILE"
fi
echo "  [6] mu-plugin fixture: auditra-mu-fixture.php"
...
[ -f "$MU_DIR/auditra-mu-fixture.php" ] && echo "  mu-plugin fixture: present"
